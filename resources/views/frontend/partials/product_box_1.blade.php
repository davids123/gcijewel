<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white product_list">
    <div class="position-relative">
        <a href="{{ route('product', $product->slug) }}" class="d-block">
            <img
                class="img-fit mi_cust_img lazyload mx-auto"
        ...
        <div class="absolute-top-right aiz-p-hov-icon">
          ...
          <!-- <a href="javascript:void(0)" onclick="showAddToCartModal({{ $product->id }})" data-toggle="tooltip" data-title="{{ translate('Add to cart') }}" data-placement="left">
               ...
               <a href="{{ route('product', $product->slug) }}"  data-toggle="tooltip" data-title="{{ translate('view details') }}" data-placement="left">
               <i class="las la-eye"></i>
            </a>
        </div>
    </div>
    ...
    <div class="p-md-3 p-2 text-left">
        ...
        <div class="fs-15">
            ...
            @elseif(home_discounted_base_price($product) !="$0.00")
                <span class="fw-700 text-primary">{{ home_discounted_base_price($product) }}</span>
            @else
                <span class="fw-700 text-primary">Price On Request </span>
            @endif
        </div>
