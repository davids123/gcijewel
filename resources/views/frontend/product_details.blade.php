        ...
        <div class="container">
            <p>
             <a href="{{Route('home')}}"> Home </a>/
              @if(!empty($detailedProduct->productType->listing_type)) <a href="{{ route('products.listing_type', $detailedProduct->productType->listing_type) }}">{{$detailedProduct->productType->listing_type}} </a>/ @endif
               @if(!empty($detailedProduct->productType->listing_type)) <a href="{{ route('products.listing_type', $detailedProduct->productType->listing_type) }}?condition={{$detailedProduct->productconditions_name}}">{{$detailedProduct->productconditions_name}} </a>/ @endif
              @if(!empty($detailedProduct->brand->name)) <a href="{{ route('suggestion.search',$detailedProduct->brand->name) }}"> {{$detailedProduct->brand->name }} </a>  / @endif
              @if(!empty($detailedProduct->category->name)) <a href="{{ route('suggestion.search',$detailedProduct->category->name) }}"> {{$detailedProduct->category->name }}  </a> / @endif
              @if(!empty($detailedProduct->model)) <a href="{{ route('suggestion.search',$detailedProduct->model) }}"> {{$detailedProduct->model }} </a>  / @endif
              @if(!empty($detailedProduct->stock_id)) <a href="{{ route('suggestion.search',$detailedProduct->stock_id) }}"> {{$detailedProduct->stock_id }} </a> @endif
            </p>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="">
                                            ...
                                            <strong class="h2 fw-600 text-primary">
                                                ...
                                                @if(home_discounted_price($detailedProduct)== "$0.00")
                                                   Price On Request
                                                @else
                                                    {{ home_discounted_price($detailedProduct) }}
                                                @endif
                                            ...
                                            @elseif($detailedProduct->unit != null)
                                        ...
                                        <div class="col-7 text-left">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span class="fs-17 fw-600 text-primary">
                                                    @if(home_discounted_base_price($top_product) == "$0.00")
                                                       Price On Request
                                                    @else
                                            ...
                                            <tr>
                                              ...
                                              <td >@if(!empty($memo))
                                                ...
                                                @if($memo->item_status == 1)
                                                  ...
                                                  <b>On Hold ({{$detailedProduct->warehouse_name}})</b>

                                                  @elseif($memo->item_status == 3)

                                                    <b>Available ({{$detailedProduct->warehouse_name}})</b>
                                              ...
                                              @else
                                                ...
                                                <b>
                                                    ...
                                                    @if($detailedProduct->published == 1)

                                                        Available ({{$detailedProduct->warehouse_name}})
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            ...
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    @php
                    $LSType = "";
                    if($detailedProduct->productType != ""){
                      $LSType = $detailedProduct->productType->listing_type;
                    }
                    @endphp
                    <input type="hidden" name="product_id" value="{{ $detailedProduct->id }}">
                    <input type="hidden" name="productname" value="{{ $detailedProduct->name }}">
                    <input type="hidden" name="productstock" value="{{ $detailedProduct->stock_id }}">
                    <input type="hidden" name="productmodel" value="{{ $detailedProduct->model }}">
                    <input type="hidden" name="productLS" value="{{ $LSType }}">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="reference" value="" placeholder="{{ translate('Reference') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3" name="email" value="" placeholder="{{ translate('Email') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <!-- <textarea class="form-control" rows="8" placeholder="{{ translate('Your Question') }}">{{ route('product', $detailedProduct->slug) }}</textarea> -->
