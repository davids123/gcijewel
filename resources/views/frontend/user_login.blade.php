                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="">
                                    <form class="form-default" id="user-capcha-login" role="form" action="{{ route('login') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="mb-5">
                                            <button type="button" class="btn btn-primary btn-block fw-600 loginClk" >{{  translate('Login') }}</button>
                                        </div>
                                    </form>
...
<script src="https://www.google.com/recaptcha/api.js" async defer></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            // alert('helloman');
            $(".loginClk").on("click", function(evt)
            {
                ...
                //reCaptcha not verified
                    alert("please verify you!");
                    evt.preventDefault();
                    return false;
                }
                //captcha verified
                //do the rest of your validations here
                $("#user-capcha-login").submit();
            });
        });
    </script>
@endsection
