        ...
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('retailreseller.update', $retailreseller->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Contact Name')}}" id="contact_name" name="contact_name" class="form-control" value="{{ $retailreseller->contact_name }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Contact Email')}}" id="contact_email" name="contact_email" class="form-control" value="{{ $retailreseller->contact_email }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Contact Phone No')}}" id="contact_phone_no" name="contact_phone_no" class="form-control" value="{{ $retailreseller->contact_phone_no }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Terms')}}" id="terms" name="terms" class="form-control" value="{{ $retailreseller->terms }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Website')}}" id="website" name="website" class="form-control" value="{{ $retailreseller->website }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Tax ID')}}" id="tax_id" name="tax_id" class="form-control" value="{{ $retailreseller->tax_id }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Billing Address')}}" id="billing_address" name="billing_address" class="form-control" value="{{ $retailreseller->billing_address }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Billing City')}}" id="billing_city" name="billing_city" class="form-control" value="{{ $retailreseller->billing_city }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Billing State')}}" id="text_billing_state" name="text_billing_state" class="form-control" value="{{ $retailreseller->text_billing_state }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Billing Country')}}" id="billing_country" name="billing_country" class="form-control" value="{{ $retailreseller->billing_country }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{ translate('Billing Zipcode')}}" id="billing_zipcode" name="billing_zipcode" class="form-control" value="{{ $retailreseller->billing_zipcode }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="Customer Group">
