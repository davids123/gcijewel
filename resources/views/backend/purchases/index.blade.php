<style>
    ...
    .all_purchases_bulk_export_btn{
        position: absolute;
        right: 23px;
        z-index: 9999;
    }
    .all_purchases_bulk_export_btn .dropdown-menu-right.show {
	padding: 0px;
}
.all_purchases_bulk_export_btn .dropdown-menu-right.show #product_export {
...
@section('content')
	...
	<div class="row ouder_report_agent">
    	<div class="col-md-12">
    	    <div class="list_bulk_btn all_purchases_bulk_export_btn">
						...
						<tbody>
							...
							@foreach($PurchasesData as $key => $optData)
								...
								<tr>
									...
									<td><a href="{{route('products.admin.edit', ['id'=>$optData->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" style="color:#000;">{{ date('m/d/20y', strtotime($optData->dop))}}</td>
