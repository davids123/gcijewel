...
<div class="card">
    ...
    <ul class="nav nav-tabs nav-fill mb-3" id="ex1" role="tablist" style="display:-webkit-inline-box;">
        <li class="nav-item" role="presentation" style="width:100px !important;" >
            <a class="nav-link active" style="width:100px;" id="ex2-tab-1" data-toggle="tab" href="#a" role="tab" aria-controls="ex2-tabs-1" aria-selected="true">Product Details</a>
        </li>
        <li class="nav-item" role="presentation" style="width:100px !important;">
                                ...
                                <table class="table table-borderless table-striped dfTable table-right-left">
                                    <tbody>
                                        @if(!empty($product))
                                            ...
                                            @php
                                                $returnPro="";
                                                $return=App\ReturnItems::where('product_id',$product->id)->first();
                                                if($return != "")
                                                {
                                            ...
                                            <td>
                                                ...
                                                @elseif($returnPro ==$product->id)
                                                    <b>Return</b>
                                                @elseif($product->item_status == '1' || $product->item_status == '0')
                                                    <b>Memo</b>
                                                @elseif($product->item_status == 2)
                                                    <b>Invoice</b>
                                                @elseif($product->item_status == 3)
                                                    <b>Available</b>
                                                @elseif($product->item_status == 4)
                                                    <b>Trade</b>
                                                @elseif($product->item_status == 5)
                                                    <b>Available</b>
                                                @elseif($product->item_status == 6)
                                                    <b>Trade NGD</b>
                                    ...
                                    @if($product->listing_type != 'Bezel' && $product->listing_type != 'Dial'&& $product->listing_type != 'Straps')
                                        <tr>
                                            <td>Serial No</td>
                                  ...
                                  @if($product->listing_type == 'Watch')
                                        <tr>
                                             <td>Supplier</td>
                                            <td><b>{{$product->supplier_name}} </b></td>
                                        </tr>
                                        <tr>
                                             <td>Age</td>
                                                        ...
                                                        @if($inventoryRun->user == $product->user_id)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="cls_store_number"> <a href =""><b>{{$product->supplier_name}}</b></a></div>
                                                                    <div class="cls_store_number"> <a href =""><b>{{$product->company}}</b></a></div>
                                                                </td>
