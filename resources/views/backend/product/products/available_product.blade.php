...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5 allproductsfltr">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ translate('Available Products') }}</h5>
            </div>
            ...
            <table class="table aiz-table mb-0" id="ProductDataTable">
                <thead>
                    <tr class="all_product">
                        ...
                        @endforeach
                       <th class="text-center" data-orderable="false"> Options </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('products.viewproduct',['id'=>$detailedProduct->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" style="color:#000;">
                                ...
                                @if(isset($detailedProduct->$filterkey) && $detailedProduct->$filterkey != null)
                        ...
                        <td> <a href="{{ route('products.viewproduct',['id'=>$detailedProduct->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" style="color:#000;">{{isset($detailedProduct->$filterkey) ? $detailedProduct->$filterkey : '';}} </a></td>
