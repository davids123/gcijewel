            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="paper_cart">
                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-control aiz-selectpicker" name="paper_cart" id="paper_cart" data-live-search="true">
                                  ...
                                  <option value="" >{{ translate('Select Paper/Cert') }}</option>
                        ...
                        <!--            <option value="{{ $color->id }}" @if($product->colors==$color->id) selected @endif>{{ $color->name }}</option>-->
                ...
                <div class="card">
                    ...
                    @if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->inner_permissions)))
                      <div class="form-group row">
                        ...
                        <!--    <label class="col-lg-3 col-from-label">{{translate(' Price In Request ')}}</label>-->

                        <!--    <div class="col-lg-6">-->

                        <!--        <input type="text" placeholder="{{translate('Price In Request')}}" name="sale_price_request" class="form-control" value="{{$product->sale_price_request}}">-->
                            ...
                            <div class="col-md-12">
                               ...
                               <div class="form-group">
                                ...
                                <select class="form-control aiz-selectpicker" name="custom_{{$i}}" data-live-search="true">
                                  <option value="">Select {{ $sma_product_type->$countCustom }}</option>
