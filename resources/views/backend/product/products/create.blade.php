            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body add_mi_product">
                        ...
                        <!--    <label class="col-md-12 col-from-label">{{translate('Color')}}</label>-->

                        <!--    <div class="col-md-12 d-flex">-->

                        <!--        <select class="form-control aiz-selectpicker" name="colors" id="colors" data-live-search="true" >-->

                        <!--            <option value="">{{ translate('Select Color') }}</option>-->

                        <!--            @foreach (\App\Color::select('colors.*')->get() as $color)-->
                ...
                <div class="card">
                    ...
                    @endif
                      ...
                      <!--    <label class="col-md-12 col-from-label">{{translate('Price In Request')}} </label>-->

                      <!--    <div class="col-md-12">-->

                      <!--        <input type="number" lang="en" min="0" value="0" step="0.01" value="{{ old('sale_price_request') }}" placeholder="{{ translate('Price In Request') }}" name="sale_price_request" class="form-control" >-->
...
$('#ajax-unit-form').on('submit', function(e) {
  ...
  $.ajax({
      ...
      success: function( response ) {
        ...
        $('#'+optName).selectpicker("val", response.added_id);
...
$('#ajax-condition-form').on('submit', function(e) {
  ...
  $.ajax({
      ...
      success: function( response ) {
        ...
        $('#productcondition').selectpicker("val", response.added_id);
  ...
  $.ajax({
      ...
      success: function( response ) {
        ...
        $('#brand_id').selectpicker("refresh");
          $('#brand_id').selectpicker("val", response.added_id);
  ...
  $.ajax({
      ...
      success: function( response ) {
        ...
        $('#warehouse_id').selectpicker("refresh");
          $('#warehouse_id').selectpicker("val", response.added_id);
  ...
  $.ajax({
      ...
      success: function( response ) {
        ...
        $('#category_id').selectpicker("refresh");
          $('#category_id').selectpicker("val", response.added_id);
    ...
    //   dataType: "json",
      ...
      success: function( response ) {
        ...
        $('#supplier_id').selectpicker("refresh");
          $('#supplier_id').selectpicker("val", response.added_id);
