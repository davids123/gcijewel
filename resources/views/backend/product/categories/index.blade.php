  ...
  <div class="card">
    ...
    <div class="card-body">
        <table class="table mb-0" id="site_category">
            <thead>
                <tr>
                    <th class="text-center-" data-breakpoints="lg">#</th>
                    <th class="text-center-">{{translate('Name')}}</th>
                    <!-- <th data-breakpoints="lg">{{ translate('Parent Category') }}</th> -->
                    <th class="text-center-" data-breakpoints="lg">{{ translate('Description') }}</th>
                    <th data-breakpoints="lg">{{ translate('Parent Category') }}</th>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="parent_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                <option value="0"name="parent_id1">{{ translate('No Parent') }}</option>
