		...
		<div class="card">
		    ...
		    <div class="card-body">
		                    ...
		                    <tr>
	                          ...
	                          <td style="text-align:center;"><input type="checkbox" class="pro_checkbox" data-id="{{$trade_ngd->memodetailsid}}" name="all_pro[]" value="{{$trade_ngd->memodetailsid}}"></td>
								...
								@endif
                                  ...
                                  $model=explode(',', $trade_ngd->model_numbers);  $model_number= implode(", " , $model); 
                                  
                                   $stock=explode(',', $trade_ngd->stocks);  $stock_number= implode(", " , $stock); 
                                   
                                    $serial=explode(',', $trade_ngd->skus);  $serial_number= implode(", " , $serial); 
		                        ...
		                        <td>{{ money_format("%(#1n",  $trade_ngd->row_total)."\n"}}</td>
		        ...
		        <div class="aiz-pagination">
                    ...
                    <p>
                        Showing {{ $memotrade_ngdData->firstItem() }} to {{ $memotrade_ngdData->lastItem() }} of  {{$memotrade_ngdData->total()}} entries
                      </p>
                    {{ $memotrade_ngdData->appends(request()->input())->links() }}
                     @else
                        <p>
                          Showing {{$memotrade_ngdData->count()}} of  {{$memotrade_ngdData->count()}} entries
                        </p>
                    @endif
