            ...
            <table class="table table-bordered table-hover no-margin item-table freshorder" id="itemtable">
                                ...
                                @foreach ($memo_details_product as $key => $memo_detail)
                                  ...
                                  <tr>
                                      <td><input class="memocheck"  type="checkbox" name="memocheck[]" value="{{$memo_detail->id}}" onchange="memocheckChanged()"/></td>
                                       <td><input type="hidden" name="stock_id" value="{{$memo_detail->stock_id}}">{{$memo_detail->stock_id}}</td>
                                       <td>{{$memo_detail->cost_code}}</td>
                                      <!--  <td>{{$memo_detail->description}}</td>   -->
                                    ...
                                    <!--         <span>{{ $memo_detail->description }}-</span>   -->
                                         </td>
                                        @endif
                                        ...
                                        @endif
                                        @if($memo_detail->listing_type=='Jewelry')
                                          <td >
                                             <span>{{ $name }} : </span>
                                             <span> {{ $memo_detail->model }}-</span>
                                             <span> {{ $memo_detail->sku }}-</span>
                                        ...
                                        @if($memo_detail->listing_type=='Watch Parts')
                                          <td>
                                             <span>{{ $name }} : </span>
                                             <span> {{ $memo_detail->model }}-</span>
                                             <span> {{ $memo_detail->sku }}-</span>
                                       ...
                                       <td>{{$memo_detail->product_qty}}</td>
                                        ...
                                        <td><input required type="number" min="0.5" step="0.5" name="row_total" value="<?php  echo $memo_detail->row_total;  ?>"  style="background:#fff!important; height:auto;" ></td>
                              ...
                              <tfoot>
                                <tr class="totaltr">
                                  ...
                                  <td><input type="text" class="form-control" value="{{$totalqty}}" name="sub_total" id="cls_total" placeholder="Total" readonly/></td>
                                ...
                                <tr class="totaltr">
                                  ...
                                  <td class="cls_sale_tax_td"><input type="text" class="form-control" name="shipping_charges"  value="{{ $shipping_charges }}" id="shipping_text" placeholder="Shipping"></td>
                                </tr>
                                 <tr class="totaltr">
