		...
		<div class="card">
		    <div class="card-header row gutters-5">
				<div class="col text-center text-md-left">
				  ...
				  @if(Auth::user()->user_type == 'admin' || in_array('119', json_decode(Auth::user()->staff->role->inner_permissions)))
			        ...
			        <table class="table aiz-table mb-0">
						...
						<?php  $count++; ?>
							<tr>
		                        ...
		                        <td class="text-right">
		                              @if(Auth::user()->user_type == 'admin' || in_array('120', json_decode(Auth::user()->staff->role->inner_permissions)))
		                            ...
		                            @endif
		                              @if(Auth::user()->user_type == 'admin' || in_array('121', json_decode(Auth::user()->staff->role->inner_permissions)))
