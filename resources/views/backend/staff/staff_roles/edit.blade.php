                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    ...
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="310" @php if(in_array(310, $permissions)) echo "checked"; @endphp>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    ...
                                    <input type="checkbox" name="permissions[]" class="form-control demo-sw" value="25" @php if(in_array(21, $permissions)) echo "checked"; @endphp>
                                ...
                                <table class="mi_table_permissions">
                                    ...
                                    <tr>
                                        <th>Listing type</th>
                                        <td> <input type="checkbox" name="inner_permissions[]" @php if(in_array(118, $inner_permissions)) echo "checked"; @endphp value="118"></td>
                                        <td><input type="checkbox" name="inner_permissions[]" @php if(in_array(119, $inner_permissions)) echo "checked"; @endphp value="119"></td>
                                        <td><input type="checkbox" name="inner_permissions[]" @php if(in_array(120, $inner_permissions)) echo "checked"; @endphp value="120"></td>
                                        <td><input type="checkbox" name="inner_permissions[]" @php if(in_array(121, $inner_permissions)) echo "checked"; @endphp  value="121"></td>
                                        <td class="check"><input type="checkbox" name="inner_permissions[]" @php if(in_array(122, $inner_permissions)) echo "checked"; @endphp  value="122"> export</td>
                                    </tr>
                                    <tr>
                                        <th>Inventorty Run</th>
                                        <td> <input type="checkbox" name="inner_permissions[]"  @php if(in_array(123, $inner_permissions)) echo "checked"; @endphp  value="123"></td>
                                        <td><input type="checkbox" name="inner_permissions[]"  @php if(in_array(124, $inner_permissions)) echo "checked"; @endphp value="124"></td>
                                        <td><input type="checkbox" name="inner_permissions[]"  @php if(in_array(125, $inner_permissions)) echo "checked"; @endphp value="125"></td>
                                        <td><input type="checkbox" name="inner_permissions[]"  @php if(in_array(126, $inner_permissions)) echo "checked"; @endphp value="126"></td>
                                        <td class="check"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(127, $inner_permissions)) echo "checked"; @endphp value="127"> export</td>
                                    </tr>
                                    <tr>
                                        <th>product</th>
                                        ...
                                        <td class="check"> <input type="checkbox" name="inner_permissions[]" @php if(in_array(16, $inner_permissions)) echo "checked"; @endphp value="16">product cost <input type="checkbox" name="inner_permissions[]" @php if(in_array(17, $inner_permissions)) echo "checked"; @endphp value="17">units <input
                                                ...
                                                type="checkbox" name="inner_permissions[]" @php if(in_array(27, $inner_permissions)) echo "checked"; @endphp value="27">export
                                                <input type="checkbox" name="inner_permissions[]" @php if(in_array(202, $inner_permissions)) echo "checked"; @endphp value="202">All Uploads 
                                                <input type="checkbox" name="inner_permissions[]" @php if(in_array(203, $inner_permissions)) echo "checked"; @endphp value="203">Product Uploads
                                                </td>
                                    </tr>
                                    <tr>
                                        <th>memo</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="check"><input type="checkbox" name="inner_permissions[]" @php if(in_array(140, $inner_permissions)) echo "checked"; @endphp value="140">export</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="check"><input type="checkbox" name="inner_permissions[]" @php if(in_array(141, $inner_permissions)) echo "checked"; @endphp value="141">export</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="check"><input type="checkbox" name="inner_permissions[]" @php if(in_array(142, $inner_permissions)) echo "checked"; @endphp value="142">export</td>
                                    ...
                                    <tr class="rowspan">
                                        ...
                                        <td class="memo" colspan="5"><input type="checkbox" name="inner_permissions[]" @php if(in_array(70, $inner_permissions)) echo "checked"; @endphp value="70"> In House Product sale<input type="checkbox" name="inner_permissions[]" @php if(in_array(204, $inner_permissions)) echo "checked"; @endphp value="204"> Sales Report <input type="checkbox" name="inner_permissions[]" @php if(in_array(71, $inner_permissions)) echo "checked"; @endphp value="71"> warehouses stock <input
                                                type="checkbox" name="inner_permissions[]" @php if(in_array(72, $inner_permissions)) echo "checked"; @endphp value="72"> best sellers <input type="checkbox" name="inner_permissions[]" @php if(in_array(73, $inner_permissions)) echo "checked"; @endphp value="73"> products Report <input type="checkbox" name="inner_permissions[]" @php if(in_array(74, $inner_permissions)) echo "checked"; @endphp value="74"> profit and/or
                                            ...
                                            suppliers <input type="checkbox" name="inner_permissions[]" @php if(in_array(78, $inner_permissions)) echo "checked"; @endphp value="78"> User Searches <input type="checkbox" name="inner_permissions[]" @php if(in_array(200, $inner_permissions)) echo "checked"; @endphp value="200"> Short Stock Report<input type="checkbox" name="inner_permissions[]" @php if(in_array(143, $inner_permissions)) echo "checked"; @endphp value="143"> export </td>
                                    ...
                                    <tr class="dashbord">
                                        ...
                                        <td class="dash" colspan="5"> <input type="checkbox" name="inner_permissions[]" @php if(in_array(84, $inner_permissions)) echo "checked"; @endphp value="84"> customers <input type="checkbox" name="inner_permissions[]" @php if(in_array(85, $inner_permissions)) echo "checked"; @endphp value="85"> suppliers <input
                                                ...
                                                type="checkbox" name="inner_permissions[]" @php if(in_array(89, $inner_permissions)) echo "checked"; @endphp value="89"> job orders <input type="checkbox" name="inner_permissions[]" @php if(in_array(144, $inner_permissions)) echo "checked"; @endphp value="144"> Warehouse stock chart <input type="checkbox" name="inner_permissions[]" @php if(in_array(145, $inner_permissions)) echo "checked"; @endphp value="145"> Low stock  <input type="checkbox" name="inner_permissions[]" @php if(in_array(146, $inner_permissions)) echo "checked"; @endphp value="146"> Category wise Product sale <input type="checkbox" name="inner_permissions[]" @php if(in_array(147, $inner_permissions)) echo "checked"; @endphp value="147"> Model wise product sale         <input type="checkbox" name="inner_permissions[]" @php if(in_array(501, $inner_permissions)) echo "checked"; @endphp value="501"> Total Job orders <input type="checkbox" name="inner_permissions[]" @php if(in_array(502, $inner_permissions)) echo "checked"; @endphp value="502">Total Available Inventory <input type="checkbox" name="inner_permissions[]" @php if(in_array(503, $inner_permissions)) echo "checked"; @endphp value="503"> Total memos <input type="checkbox" name="inner_permissions[]" @php if(in_array(504, $inner_permissions)) echo "checked"; @endphp value="504"> Total Product Brand </td>
                                    ...
                                    <tr>
                                        <th>People</th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(98, $inner_permissions)) echo "checked"; @endphp value="98"> user list <input type="checkbox" name="inner_permissions[]"  @php if(in_array(99, $inner_permissions)) echo "checked"; @endphp value="99"> list agent
                                          <input type="checkbox" name="inner_permissions[]"  @php if(in_array(100, $inner_permissions)) echo "checked"; @endphp value="100"> all customer<input type="checkbox" name="inner_permissions[]"  @php if(in_array(101, $inner_permissions)) echo "checked"; @endphp value="101"> all seller <input
                                                type="checkbox" name="inner_permissions[]"  @php if(in_array(102, $inner_permissions)) echo "checked"; @endphp value="102">List Expertise  <input type="checkbox" name="inner_permissions[]"  @php if(in_array(201, $inner_permissions)) echo "checked"; @endphp value="201"> Permission</td>
                                    </tr>
                                    <tr>
                                        <th>System</th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(103, $inner_permissions)) echo "checked"; @endphp value="103"> system setting <input type="checkbox" name="inner_permissions[]"  @php if(in_array(104, $inner_permissions)) echo "checked"; @endphp value="104"> tax rates <input
                                                type="checkbox" name="inner_permissions[]"  @php if(in_array(105, $inner_permissions)) echo "checked"; @endphp value="105">update <input type="checkbox" name="inner_permissions[]"  @php if(in_array(106, $inner_permissions)) echo "checked"; @endphp value="106"> server status </td>
                                    </tr>   
                                     <tr>
                                        <th>Fields </th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]" @php if(in_array(107, $inner_permissions)) echo "checked"; @endphp value="107"> Brand<input type="checkbox" name="inner_permissions[]" @php if(in_array(108, $inner_permissions)) echo "checked"; @endphp value="108"> Category <input
                                                type="checkbox" name="inner_permissions[]" @php if(in_array(109, $inner_permissions)) echo "checked"; @endphp value="109">Condition <input type="checkbox" name="inner_permissions[]" @php if(in_array(110, $inner_permissions)) echo "checked"; @endphp value="110"> Metal<input type="checkbox" name="inner_permissions[]" @php if(in_array(111, $inner_permissions)) echo "checked"; @endphp value="111"> Model Number<input type="checkbox" name="inner_permissions[]" @php if(in_array(112, $inner_permissions)) echo "checked"; @endphp value="112"> Partners<input type="checkbox" name="inner_permissions[]"  @php if(in_array(113, $inner_permissions)) echo "checked"; @endphp value="113"> Size <input type="checkbox" name="inner_permissions[]" @php if(in_array(114, $inner_permissions)) echo "checked"; @endphp value="114"> Unit<input type="checkbox" name="inner_permissions[]"  @php if(in_array(115, $inner_permissions)) echo "checked"; @endphp value="115"> Warehouse <input type="checkbox" name="inner_permissions[]" @php if(in_array(116, $inner_permissions)) echo "checked"; @endphp value="116"> Print Barcode /Label</td>
                                    </tr>
                                    <tr>
                                        <th>Newsletter </th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(128, $inner_permissions)) echo "checked"; @endphp value="128"> Newsletters<input type="checkbox" name="inner_permissions[]"  @php if(in_array(129, $inner_permissions)) echo "checked"; @endphp value="129"> Subcribers 
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Website Setup </th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(130, $inner_permissions)) echo "checked"; @endphp  value="130"> Header<input type="checkbox" name="inner_permissions[]"  @php if(in_array(131, $inner_permissions)) echo "checked"; @endphp  value="131"> Footer <input type="checkbox" name="inner_permissions[]"  @php if(in_array(132, $inner_permissions)) echo "checked"; @endphp  value="132"> Pages <input type="checkbox" name="inner_permissions[]"  @php if(in_array(133, $inner_permissions)) echo "checked"; @endphp  value="133"> Appearance 
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Setup & Configurations </th>
                                        <td class="deposit" colspan="5"><input type="checkbox" name="inner_permissions[]"  @php if(in_array(134, $inner_permissions)) echo "checked"; @endphp  value="134"> General Settings <input type="checkbox" name="inner_permissions[]"  @php if(in_array(135, $inner_permissions)) echo "checked"; @endphp value="135"> Currency <input type="checkbox" name="inner_permissions[]"  @php if(in_array(136, $inner_permissions)) echo "checked"; @endphp value="136"> STMP Settings <input type="checkbox" name="inner_permissions[]"  @php if(in_array(137, $inner_permissions)) echo "checked"; @endphp value="137"> Social media Logins  <input type="checkbox" name="inner_permissions[]"  @php if(in_array(138, $inner_permissions)) echo "checked"; @endphp value="138"> Facebook <input type="checkbox" name="inner_permissions[]"  @php if(in_array(139, $inner_permissions)) echo "checked"; @endphp value="139"> Google 
                                        </td>
                                    </tr>
                                </table>
                            </div>
