           ...
           <form action="{{ route('staffs.update', $staff->id) }}" method="POST">
               ...
               <div class="card-body">
                    <div class="col-6" style="float: left;">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Name')}}" id="name" name="name" value="{{ $staff->name }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('company')}}" id="company" name="company" class="form-control" value="{{ $staff->company }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 col-from-label" >{{translate('Email *')}}</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('Email')}}" id="email" name="email" value="{{ $staff->email }}" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group ">
                            <label class="col-sm-3 col-from-label">{{translate('Phone *')}}</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('Phone')}}" id="mobile" name="mobile" value="{{ $staff->phone }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                <select  id="status" name="status" class="form-control" required>
                                    ...
                                    <option value='0'  @if($staff->status=='0'){{'selected'}}@endif>Deactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group ">
