...
<div class="dropdown mb-2 mb-md-0 right_drop_mune_sec trans_mi">
    ...
    <div class="dropdown-menu dropdown-menu-right">
                ...
                <form class="" action="{{route('product_report_excel.index')}}" method="post">
                    @csrf
    ...
    <div class="col-md-12 mx-auto">
        <div class="card">
                <form class="" id="sort_products" action="" method="GET">
                    ...
                    @php $memo=1; $invoce=2; $trade=4; $tradeNgd=6; $available="available"; @endphp
                    <div class="col-md-3 d-flex">
                        ...
                        <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" name="memo_status" id="memoStatus" data-live-search="true">
                            ...
                            <option value="{{$available}}"  @if($available== Request::get('memo_status')) selected @endif>Available</option>
                        </select>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="checkbox" class="pro_checkbox" data-id="{{$row->id}}" name="all_pro[]" value="{{$row->id}}"></td>
                                 ...
                                 <td>@if($pagination_qty != "all") {{ ($PurchasesData->currentpage()-1) * $PurchasesData->perpage() + $key + 1 }} @else {{ $key + 1 }} @endif</td>
                                <td> {{$row->stock_id}}</td>
                                <td> 
                                <?php
