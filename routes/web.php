...
Route::get('/clear-app-cache', function () {
    Cache::flush();
    return redirect()->back()->with('success', 'Application cache has clear successfully!');
});
...
Route::get('/mailBangleExport', 'DemoController@BangleExcel');
...
//Home Page
 Route::post('/conversations/diamond','ConversationController@diamond_model_store')->name('conversations.diamond.store');
Route::get('/', 'HomeController@index')->name('home');
Route::get('/pdfloader', 'HomeController@pdfloader');

Route::post('/home/section/featured', 'HomeController@load_featured_section')->name('home.section.featured');
Route::post('/home/section/watch_parts', 'HomeController@load_watch_parts_section')->name('home.section.watch_parts');
Route::post('/home/section/jewelry', 'HomeController@load_jewelry_section')->name('home.section.jewelry');
Route::post('/home/section/used-product', 'HomeController@load_used_product_section')->name('home.section.used_condition');
Route::post('/home/section/new-product', 'HomeController@load_new_product_section')->name('home.section.new_condition');
...
Route::get('/search-request/brand', 'SearchController@brand_ids')->name('brand_search.filter');
Route::get('/listing-type/{listing_type}', 'SearchController@listingByListing_type')->name('products.listing_type');
Route::get('/brand/{brand_slug}', 'SearchController@listingByBrand')->name('products.brand');
Route::get('/watch-service', 'SearchController@watch_service')->name('products.watch_service');
Route::post('/watch-service-store', 'SearchController@watch_service_store')->name('products.watch_service_store');
Route::get('/sell-my-watch/create', 'SearchController@sell_my_watch_create')->name('sell_my_watch.create');
Route::post('/sell-my-watch/store', 'SearchController@sell_my_watch_store')->name('sell_my_watch.store');
Route::post('/watch-request/store', 'SearchController@watch_request')->name('watch_request.store');
Route::get('/watch_and_jewelry_service/create', 'SearchController@watch_and_jewelry_service')->name('watch_and_jewelry_service.create');




Route::get('/product/{slug}', 'HomeController@product')->name('product');
Route::get('/captch-servi/{rand}', 'HomeController@captch_service')->name('captch_service');
...
Route::get('/about_us_p', 'HomeController@returnpolicy')->name('returnpolicy');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    // Route::post('/conversations/diamond','ConversationController@diamond_model_store')->name('conversations.diamond.store');
    Route::post('/conversations/gold-collectibles','ConversationController@gold_collectibles_store')->name('gold.collectibles.store');
    Route::post('/conversations/memorabilia','ConversationController@memorabilia_store')->name('memorabilia.store');
