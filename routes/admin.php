...
Route::post('/admin/stockChart-1', 'AdminController@stockChart_1')->name('dashboard.stockChart_1');
...
Route::post('/edit/email/steved', 'NewsletterController@emailTo')->name('edit.email');
    ...
    Route::get('/products/available-products', 'ProductController@available_products')->name('products.available.products');
    ...
    Route::post('/products/Bracodes_label', 'BarcodeController@BarcodeAjaxLabel')->name('products.BarcodeAjaxLabel');
    ...
    Route::post('/products/admin/barcodestoreReturn', 'BarcodeController@barcode_return')->name('products.barcode_return');
  ...
  // Return ReturnCreate
    ...
    Route::get('sellers_ban/{id}', 'SellerController@ban')->name('sellers.ban');
     ...
     Route::get('/sellers/show/{id}', 'SellerController@show')->name('sellers.show');


      Route::post('/sellers/update/{id}', 'SellerController@update')->name('sellers.update');
    ...
    Route::group(['prefix' => 'website'], function() {
        ...
        Route::get('/product_section', 'WebsiteController@product_section')->name('website.product_section');

        Route::get('/product_section/edit/{id}', 'WebsiteController@product_section_edit')->name('website.product_section_edit');

        Route::post('/product_section/update/{id}', 'WebsiteController@product_section_update')->name('website.product_section_update');
    ...
    Route::post('/short_stock_excel', 'ReportController@short_stock_excel')->name('short_stock_excel.index');
    Route::get('/average_cost_report', 'ReportController@average_cost_report')->name('average_cost_report.index');

    Route::post('/supplier_excel', 'ReportController@supplier_excel')->name('supplier_excel.index');
    Route::get('/supplier_details_excel', 'ReportController@supplier_details_excel')->name('supplier_details_excel.index');

    Route::post('/best_seller_excel', 'ReportController@best_seller_excel')->name('best_seller_excel.index');
    Route::post('/average_report_excel', 'ReportController@average_report_excel')->name('average_report_excel.index');
    Route::post('/seller_sale_report_excel', 'ReportController@seller_sale_report_excel')->name('seller_sale_report_excel.index');
    Route::post('/product_report_excel', 'ReportController@product_report_excel')->name('product_report_excel.index');
    Route::post('/customer_report_excel', 'ReportController@customer_report_excel')->name('customer_report_excel.index');
...
// Route::get('/seller_sale_report_excel', 'ReportController@seller_sale_report_excel')->name('seller_sale_report_excel.index');
    ...
    Route::post('/agent_report-export', 'JobOrdersReportController@agent_report_export')->name('agent_report_export.index');
    Route::post('/client_report-export', 'JobOrdersReportController@client_report_export')->name('client_report_export.index');
    Route::post('/complete_report_export', 'JobOrdersReportController@complete_report_export')->name('complete_report_export.index');
    Route::post('/pendingJob_report_export', 'JobOrdersReportController@pendingJob_report_export')->name('pendingJob_report_export.index');
    Route::post('/onHoldJob_report_export', 'JobOrdersReportController@onHoldJob_report_export')->name('onHoldJob_report_export.index');
    Route::post('/openJob_report_export', 'JobOrdersReportController@openJob_report_export')->name('openJob_report_export.index');
    Route::post('/pastDueJob_report_export', 'JobOrdersReportController@pastDueJob_report_export')->name('pastDueJob_report_export.index');
