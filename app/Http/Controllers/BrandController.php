...

{
    ...
    public function getAllbrand(Request $request){
        ...
        foreach($records as $rkey => $record){
           ...
           $data_arr[] = array(
               ...
               <a href="'.route('brands.destroy', $id).'" onclick="return confirm(\'Are you sure?\');" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="'.route('brands.destroy', $id).'">
...

    {
      ...
      // Add Unit...
       ...
       return response()->json(['success' => true,'brandHTML'=>$brandOptionHtml,'tagHtmlData'=>$tagHtmls,'added_id'=>$brand->id]);
