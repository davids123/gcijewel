...
class ProductController extends Controller
{
    ...
    public function available_products()
    {
      ...
      $productQry  = Product::leftJoin('warehouse','warehouse.id','=','products.warehouse_id')
                      ...
                      ->groupBy('products.id')
                      ->select('products.*','product_types.listing_type','categories.name as categories_name','product_stocks.qty','product_stocks.sku','brands.name as brand_name','product_types.product_type_name','warehouse.name as warehouse_name','users.name as user_name','site_options.low_stock')
                      ->get();
            return $productQry;
    }
}
