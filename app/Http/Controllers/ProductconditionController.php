...

{
   ...
   // Productcondition Start
          ...
          public function getAllcondition(Request $request){
              ...
              foreach($records as $rkey => $record){
                 ...
                 $data_arr[] = array(
                     ...
                     <a href="'.route('productcondition.destroy', $id).'" onclick="return confirm(\'Are you sure?\');" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="'.route('productcondition.destroy', $id).'">
...

    {
        ...
        return view('backend.site_options.productcondition.edit', compact('partners','lang'));
...

    {
      ...
      // Add Unit...
       ...
       return response()->json(['success' => true,'conHtml'=>$conditionHtml,'added_id'=>$Productconditions->id]);
