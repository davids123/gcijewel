        ...
        foreach($records as $rkey => $record){
           ...
           $data_arr[] = array(
               ...
               "link" => '<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="'.route('partners.edit', ['id'=>$id, 'lang'=>env('DEFAULT_LANGUAGE')] ).'">
                          ...
                          <a href="'.route('soption.destroy', $id).'" onclick="return confirm(\'Are you sure?\');" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="'.route('soption.destroy', $id).'">
               ...
               // Listing type Start
...

                {
                  ...
                  $Request->validate([
                    ...
                    return redirect()->route('Listingtype.index');
