...

{
    ...
    */
    ...
    //   dd($product);
        $arry=array(1,0);
        $memo_details=Memo::select('memo_details.item_status','memo_details.product_id')
            ...
            foreach($gallery_img as $photos){
               ...
               else if($product->item_status=='1' && in_array($product->id,$product_ids))
                {
                    $memostatus='Memo';
                }
                else if($product->item_status=='0' && in_array($product->id,$product_ids))
                {
                    $memostatus='Memo';
                }
